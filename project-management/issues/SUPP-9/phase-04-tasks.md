...
### Setup
- [ ] [impl] Verify existing tests pass locally with `./mill __.test`

### Implementation
- [ ] [impl] Add `test` job to `.github/workflows/ci.yml`
- [ ] [impl] Configure test job to depend on compile job
- [ ] [impl] Add test execution step with `./mill __.test`

### Validation
- [ ] [impl] Verify CI workflow YAML syntax is valid
