// PURPOSE: Integration tests for MySQL PermissionRepository implementation
// PURPOSE: Verifies repository operations using real MySQL database with Testcontainers
...
object MySQLPermissionRepositorySpec extends ZIOSpecDefault:

  def spec = suite("MySQLPermissionRepositorySpec")(
    ...
    MySQLPermissionRepository.layer,
    flywayMigrationServiceLayer
  ) @@ sequential

end MySQLPermissionRepositorySpec
