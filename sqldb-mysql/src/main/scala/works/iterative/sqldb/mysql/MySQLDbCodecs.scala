...
/** Shared DbCodecs for MySQL entities.
  ...
  *   1. Timestamp has native JDBC/Magnum support 2. Avoids circular dependency: Magnum's Instant
  *      codec uses OffsetDateTime, so defining OffsetDateTime in terms of Instant creates a
  *      deadlock
  */
