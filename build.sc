...
object core extends CrossModule {
  ...
  object testUtils extends JvmOnlyModule {
    ...
    object test extends BaseTests {
      override def moduleDir = core.testUtils.moduleDir
      override def sources = Task.Sources(moduleDir / "src" / "test" / "scala")
      override def resources = Task.Sources(moduleDir / "src" / "test" / "resources")
    }
  }
}
...
object http extends JvmOnlyModule {
  ...
  object test extends BaseTests {
    override def moduleDir = http.moduleDir
    override def intellijModulePath: os.Path = http.moduleDir / "src/test"
  }
}
