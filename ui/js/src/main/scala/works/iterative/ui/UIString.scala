...
/** UIString is meant to mark the strings that are part of the UI and subject to localization
  * Another mechanism can later be used to find all these strings and customize.
  */
