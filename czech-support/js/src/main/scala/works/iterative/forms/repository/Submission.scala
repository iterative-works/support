// PURPOSE: Submission aggregate for Czech form intake — payment state, variable symbol,
// PURPOSE: departments and processing status derived from the submitted content
